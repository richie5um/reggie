...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsToggleSwitchToggleSwitchComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _utils_regex_util__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./utils/regex.util */
    ...
    var AppComponent = /*#__PURE__*/function () {
      ...
      _createClass(AppComponent, [{
        ...
        key: "load",
        value: function load() {
          var matches = this.localStorageService.getJson('re-matches');
          this.regexMatches = matches ? matches : [{
            text: this.regexmatch
          }];
          var matchesIndex = this.localStorageService.getJson('re-matchesindex');
          ...
          var replaces = this.localStorageService.getJson('re-replaces');
          this.regexReplaces = replaces ? replaces : [{
            text: this.regexreplace
          }];
          var replacesIndex = this.localStorageService.getJson('re-replacesindex');
          ...
          var regexoptions = this.localStorageService.getItem('re-options');
          this.regexoptions = regexoptions ? regexoptions : this.regexoptions;
          var input = this.localStorageService.getItem('re-input');
          this.input = input ? input : this.input;
          var lastaction = this.localStorageService.getItem('re-lastaction');
          this.lastAction = lastaction ? lastaction : this.lastAction;
          var options = this.localStorageService.getJson('re-alloptions');
        ...
        value: function match() {
          ...
          try {
            ...
            var regexItem = this.regexMatches[this.regexMatchesIndex];
            regexItem.text = _utils_regex_util__WEBPACK_IMPORTED_MODULE_3__["RegexUtil"].replaceAll(regexItem.text, ' ', '·');

            var regexMatch = _utils_regex_util__WEBPACK_IMPORTED_MODULE_3__["RegexUtil"].replaceAll(regexItem.text, '·', ' ');

            var regex = new RegExp(regexMatch, this.regexoptions);
            var matches = [];
            ...
            try {
              for (_iterator.s(); !(_step = _iterator.n()).done;) {
                ...
                var match = _utils_regex_util__WEBPACK_IMPORTED_MODULE_3__["RegexUtil"].matchAll(regex, input);
            ...
            try {
              for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
                ...
                var _iterator3 = _createForOfIteratorHelper(_match.results),
                    _step3;
                ...
                try {
                  for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
                    ...
                    for (var j = 0; j < results.length; ++j) {
                      var html = this.regexhtmlmarkup(results, j);
                      var range = '';

                      if (j < results.indices.length) {
                        var position = results.indices[j];

                        if (position) {
                          range = "[".concat(position[0], ", ").concat(position[1], "]");
                        }
                      }
        ...
        key: "regexhtmlmarkup",
        value: function regexhtmlmarkup(match, index) {
          var matchelements = match.input.split('');

          if (index < match.indices.length) {
            var position = match.indices[index];

            if (position) {
              matchelements.splice(position[1], 0, '</span>');
              matchelements.splice(position[0], 0, "<span class=\"highlight highlight-".concat(index, "\">"));
        ...
        value: function replace() {
          ...
          try {
            ...
            var regexReplaceItem = this.regexReplaces[this.regexReplacesIndex];
            regexReplaceItem.text = _utils_regex_util__WEBPACK_IMPORTED_MODULE_3__["RegexUtil"].replaceAll(regexReplaceItem.text, ' ', '·');

            var regexReplace = _utils_regex_util__WEBPACK_IMPORTED_MODULE_3__["RegexUtil"].replaceAll(regexReplaceItem.text, '·', ' ');
            ...
            try {
              for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
                ...
                var replace = input.replace(regex, regexReplace);
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_toggle_switch_toggle_switch_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./components/toggle-switch/toggle-switch.module */
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_6__["AppRoutingModule"], _components_toggle_switch_toggle_switch_module__WEBPACK_IMPORTED_MODULE_4__["ToggleSwitchModule"], _pipes_pipes_module__WEBPACK_IMPORTED_MODULE_5__["PipesModule"]],
      providers: [],
  ...
  /***/
  function srcAppComponentsToggleSwitchToggleSwitchComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppComponentsToggleSwitchToggleSwitchComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], ToggleSwitchComponent.prototype, "toggle", void 0);
    ToggleSwitchComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-toggle-switch',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./toggle-switch.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/toggle-switch/toggle-switch.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./toggle-switch.component.scss */
      "./src/app/components/toggle-switch/toggle-switch.component.scss"))["default"]]
  ...
  /***/
  function srcAppComponentsToggleSwitchToggleSwitchModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ToggleSwitchModule", function () {
    ...
    var src_app_directives_directives_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! src/app/directives/directives.module */
    "./src/app/directives/directives.module.ts");
    /* harmony import */


    var _toggle_switch_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./toggle-switch.component */
    "./src/app/components/toggle-switch/toggle-switch.component.ts");

    var ToggleSwitchModule = function ToggleSwitchModule() {
      _classCallCheck(this, ToggleSwitchModule);
    };

    ToggleSwitchModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], src_app_directives_directives_module__WEBPACK_IMPORTED_MODULE_4__["DirectivesModule"]],
      declarations: [_toggle_switch_component__WEBPACK_IMPORTED_MODULE_5__["ToggleSwitchComponent"]],
      exports: [_toggle_switch_component__WEBPACK_IMPORTED_MODULE_5__["ToggleSwitchComponent"]]
    })], ToggleSwitchModule);
    /***/
  },
  ...
  /***/
  function srcAppDirectivesCheckedDirectiveTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CheckedDirective", function () {
    ...
    var CheckedDirective = /*#__PURE__*/function () {
      function CheckedDirective(ngControl) {
        _classCallCheck(this, CheckedDirective);

        this.ngControl = ngControl;
      }

      _createClass(CheckedDirective, [{
        key: "contentEditable",
        set: function set(condition) {
          var action = condition ? 'checked="true"' : '';
    ...
    CheckedDirective.ctorParameters = function () {
      return [{
        type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["NgControl"]
      }];
    };

    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])('ischecked')], CheckedDirective.prototype, "contentEditable", null);
    CheckedDirective = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Directive"])({
      selector: '[appChecked]'
    })], CheckedDirective);
    /***/
  },
  ...
  /***/
  function srcAppDirectivesContenteditableDirectiveTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var ContentEditableDirective = /*#__PURE__*/function () {
      function ContentEditableDirective(ngControl) {
      ...
      _createClass(ContentEditableDirective, [{
        key: "contentEditable",
        set: function set(condition) {
          var action = condition ? 'contenteditable="true"' : '';
          this.ngControl.control[action]();
        }
      }]);
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])('contentEditable')], ContentEditableDirective.prototype, "contentEditable", null);
    ContentEditableDirective = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Directive"])({
  ...
  function srcAppDirectivesDirectivesModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _contenteditable_directive__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./contenteditable.directive */
    "./src/app/directives/contenteditable.directive.ts");
    /* harmony import */


    var _checked_directive__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./checked.directive */
    "./src/app/directives/checked.directive.ts");
    ...
    DirectivesModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [],
      declarations: [_contenteditable_directive__WEBPACK_IMPORTED_MODULE_2__["ContentEditableDirective"], _checked_directive__WEBPACK_IMPORTED_MODULE_3__["CheckedDirective"]],
      exports: [_contenteditable_directive__WEBPACK_IMPORTED_MODULE_2__["ContentEditableDirective"], _checked_directive__WEBPACK_IMPORTED_MODULE_3__["CheckedDirective"]]
    })], DirectivesModule);
    /***/
  },
  ...
  function srcAppPipesPipesModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _safehtml_pipe__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./safehtml.pipe */
    ...
    PipesModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [],
      declarations: [_safehtml_pipe__WEBPACK_IMPORTED_MODULE_2__["SafeHtmlPipe"]],
      exports: [_safehtml_pipe__WEBPACK_IMPORTED_MODULE_2__["SafeHtmlPipe"]]
    })], PipesModule);
    /***/
  },
    ...
    var LocalStorageService = /*#__PURE__*/function () {
      ...
      _createClass(LocalStorageService, [{
        ...
        value: function getItems() {
          if (this.window) {
            return Object.entries(localStorage).map(function (e) {
              return {
                key: e[0],
                value: e[1]
              };
        ...
        key: "setJson",
        value: function setJson(key, val) {
  ...
  /***/
  function srcAppUtilsRegexUtilTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "RegexUtil", function () {
      return RegexUtil;
    });
    /* harmony import */
    ...
    var regexp_match_indices__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! regexp-match-indices */
    "./node_modules/regexp-match-indices/index.js");
    /* harmony import */


    var regexp_match_indices__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(regexp_match_indices__WEBPACK_IMPORTED_MODULE_1__);

    var RegexUtil = /*#__PURE__*/function () {
      function RegexUtil() {
        _classCallCheck(this, RegexUtil);
      }

      _createClass(RegexUtil, null, [{
        key: "replaceAll",
        value: function replaceAll(input, from, to) {
          var regex = new RegExp(this.escape(from), 'g');
        ...
        key: "matchAll",
        value: function matchAll(regex, text) {
          var matches = [];
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/richs/Code/playground/angular/my-regex/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
